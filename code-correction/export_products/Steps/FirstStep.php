...
# other methods available on product API include "create", "upsert", "delete" etc..
$response = $client->getCategoryApi()->all();

# Other endpoints methods available here: vendor/akeneo/api-php-client/src/AkeneoPimClientInterface.php
